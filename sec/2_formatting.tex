...
$$
By comparing the elementwise maximum of the confidence scores by the two branches and taking the argmax of the two, we greedly get the desired class that has the global maximum confidence given by the two branches. This helps to find the most probable class label in both the situations that either an unrotated image or a rotated image has been given.
%-------------------------------------------------------------------------
