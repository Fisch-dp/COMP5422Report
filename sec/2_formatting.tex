...
$$
where $\mathcal{L}_{CE}$ denote the cross-entropy loss function, $\sigma_s$ denote the softmax function, and \mathbf{y} is the one-hot representation of the ground truth label.
